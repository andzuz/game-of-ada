package Arrays2D is
  ...
  function Get_array_from_file(Filename : String; I : Integer; J : Integer) return Array2D;
  procedure Print_array(arr : Array2D; I : Integer; J : Integer);
  procedure write_array_to_file(array2 : Array2D; Filename : String; I : Integer; J : Integer);
end Arrays2D;
