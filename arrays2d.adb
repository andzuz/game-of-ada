...
package body Arrays2D is
  ...
  function Get_array_from_file(Filename : String; I : Integer; J : Integer) return Array2D is
    File : FILE_TYPE;
  ...
  procedure write_array_to_file(array2 : Array2D; Filename : String; I : Integer; J : Integer) is
    File : FILE_TYPE;
  begin
